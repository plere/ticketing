...
public class ExceptionAdvice {
    ...
    public ResponseEntity<ResponseDto<ErrorResponseDto>> customRuntimeException(ServerException exception) {
    ...
    public ResponseEntity<ResponseDto<ErrorResponseDto>> customRuntimeException(CustomRuntimeException exception) {
        return ErrorResponseDto.from(exception.getStatus(), exception.getCode(), exception.getMessage());
    }

    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<ResponseDto<ErrorResponseDto>> customRuntimeException(MethodArgumentNotValidException exception) {
